...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(CounterHelper<Counters> counterHelper, ILogger logger)
            : this(counterHelper,
				  logger,
        ...
        public AccountController(CounterHelper<Counters> counterHelper, ILogger logger, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
			...
			if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
					...
					_counterHelper.Increment(Counters.SuccessLogInCounter);
        ...
        {
			_counterHelper.Increment(Counters.SignUpAttemptCounter);
			...
			if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
					...
					_logger.Info("User was successfully registered");
